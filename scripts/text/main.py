    ...
    for country_dir in sorted(configs_dir.iterdir()):
        ...
        if config_files:
            ...
            for config_file in sorted(config_files):
                ...
                print(
                    f"     Command: python scripts/text/main.py {newspaper_name}"
                )
...
async def run_scraper_by_name(
    ...
    **kwargs,
    ...
    config_files = find_config_files(
        get_default_configs_dir(), country=country, newspaper=newspaper_name
    )
    ...
    if len(config_files) > 1:
        ...
        for config_file in config_files:
            ...
            print(f"   {rel_path}")
        print(
            f"Using: {config_files[0].relative_to(scrapers_dir / 'configs')}"
        )
